...
export const EXERCISE_CATALOG: ExerciseCategory[] = [
  ...
  {
    category: "Forearm Flexors & Grip Exercises",
    exercises: [
      "Barbell Wrist Curl",
  ...
  {
    category: "Forearm Extensor Exercises",
    exercises: [
  ...
  {
    category: "Cardio Exercises & Equipment",
    exercises: ["Rowing Machine", "Stationary Bike"],
  },
];

export const EXERCISE_NAMES = EXERCISE_CATALOG.flatMap(
  (category) => category.exercises
);

export const EXERCISE_NAME_SET = new Set(
  EXERCISE_NAMES.map((name) => name.toLowerCase())
);
